      ...
      <div className="container mx-auto">
        <div className="md:grid md:grid-cols-3 md:gap-8">
          <div className="md:col-span-2">
            ...
            <div className="hidden md:grid md:grid-cols-3 md:gap-8 mt-14">
              <div>
        ...
        <div className="mt-8 md:mt-12 flex flex-col md:flex-row justify-between  md:items-center items-left">
          <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4 text-sm text-left">
